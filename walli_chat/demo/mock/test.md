...
This message intentionally mixes **bold**, _italic_, _**nested emphasis**_, ~~deleted text~~, `inline code`, [a safe link](https://example.com/spec), CJK 字符, العربية, and emoji ✅ to exercise inline flow inside richer block structure.
